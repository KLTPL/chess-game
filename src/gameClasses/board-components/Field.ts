...
export default class Field {
  ...
  private getLabelsForField(pos: Pos, isBoardInverted: boolean): FieldLabelInfo[]|null {
    ...
    switch (posStr) {
      case "0,0": return [{value: getNum(0), isNumber: true}];
      case "1,0": return [{value: getNum(1), isNumber: true}];
      case "2,0": return [{value: getNum(2), isNumber: true}];
      case "3,0": return [{value: getNum(3), isNumber: true}];
      case "4,0": return [{value: getNum(4), isNumber: true}];
      case "5,0": return [{value: getNum(5), isNumber: true}];
      case "6,0": return [{value: getNum(6), isNumber: true}];
      case "7,0": return [{value: getNum(7), isNumber: true}, {value: getLett(0), isNumber: false}];
      case "7,1": return [{value: getLett(1), isNumber: false}];
      case "7,2": return [{value: getLett(2), isNumber: false}];
      case "7,3": return [{value: getLett(3), isNumber: false}];
      case "7,4": return [{value: getLett(4), isNumber: false}];
      case "7,5": return [{value: getLett(5), isNumber: false}];
      case "7,6": return [{value: getLett(6), isNumber: false}];
      case "7,7": return [{value: getLett(7), isNumber: false}];
      default: return null;
    }
  }

  public invertHtml(pos: Pos, isBoardInverted: boolean) {
    this.html.querySelectorAll(`.${CLASS_NAMES.fieldLabel}`)
